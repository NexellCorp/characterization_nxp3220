...
private:
	...
	int   GetKeyValueInt(struct json_object *Jobj, const char *Key);
	bool  GetKeyValueBool(struct json_object *Jobj, const char *Key);
	int   GetKeyValueArray(struct json_object *Jobj, const char *Key, int Index);
